...
import { uploadReportValidators, reportIdParamValidator } from '../validators/medicalReportValidators.js';
...
router.get('/me/reports/:reportId/url', reportIdParamValidator, getReportSignedUrl);
